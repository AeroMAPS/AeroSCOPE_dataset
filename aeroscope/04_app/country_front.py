...
class CountriesTab:
    def __init__(self, aeroscopedataclass):
        ...
        self.select_world_button = v.Btn(children=["World View"], variant='outlined', color="light-blue-darken-4",
                                    class_="ma-2")
        ...
        self.toggle_button_plot1 = v.BtnToggle(v_model='map', children=[
    ...
    def _make_connections(self, dataclass):
        ...
        self.value_watched_radio.observe(partial(self._plot1_update, dataclass=dataclass), names='v_model')
        self.value_watched_radio.observe(partial(self._plot2_update, dataclass=dataclass), names='v_model')
        self.value_watched_radio.observe(partial(self._plot3_update, dataclass=dataclass), names='v_model')

        self.toggle_button_plot1.observe(partial(self._plot1_update, dataclass=dataclass), names='v_model')
        self.toggle_button_plot2.observe(partial(self._plot2_update, dataclass=dataclass), names='v_model')
        self.toggle_button_plot3.observe(partial(self._plot3_update, dataclass=dataclass), names='v_model')
    ...
    def _render_initial_plots(self, dataclass):
        with self.output_1:
            fig_ctry_1 = country_level_plots.countries_global_plot(dataclass.country_fixed, 'co2')
            display(fig_ctry_1)

        with self.output_2:
            fig_ctry_2 = country_level_plots.distance_histogramm_plot_country(dataclass.flights_df, 'co2')
            display(fig_ctry_2)
        ...
        if len(filtered_values) == 0:
            ...
            with self.output_1:
                ...
                if active_main_graph_country == 'map':
                    fig_ctry_1 = country_level_plots.countries_global_plot(dataclass.country_fixed, value_watched_ctry)
                else:
                    fig_ctry_1 = country_level_plots.countries_treemap_plot(dataclass.country_flows, value_watched_ctry)
                display(fig_ctry_1)

        else:
            filtered_country_flows = dataclass.country_flows[
                dataclass.country_flows['departure_country_name'].isin(filtered_values)].reset_index()
    ...
    def _plot2_update(self, change, dataclass):
        ...
        if len(filtered_values) == 0:
            ...
            filtered_flights_df = dataclass.flights_df[dataclass.flights_df['departure_country_name'].isin(filtered_values)].reset_index()
                        ...
                        v.Col(
                            ...
                            children=[
                                v.Card(
                                    ...
                                    elevation=0,
                                    children=[
                                        v.Html(tag="div", class_="d-flex justify-center", children=[self.toggle_button_plot1]),
                                        v.CardText(
                                            children=[
                                                self.output_1,
                                            ]
                        ...
                        v.Col(
                            ...
                            children=[
                                v.Card(
                                    ...
                                    elevation=0,
                                    children=[
                                        v.Html(tag="div", class_="d-flex justify-center", children=[self.toggle_button_plot3]),
                                        self.output_3
                                    ],
                                ),
                            ],
