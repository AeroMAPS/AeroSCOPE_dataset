...
class DetailledTab:
    def __init__(self, aeroscopedataclass):
        ...
        self.toggle_button_plot1 = v.BtnToggle(v_model='map', variant='outlined', children=[
        ...
        self.toggle_button_plot2 = v.BtnToggle(v_model='hist', children=[
        ...
        self.toggle_button_plot3 = v.BtnToggle(v_model='acft', variant='text', children=[
    ...
    def _make_connections(self, dataclass):
        ...
        self.departure_airport_autocomplete.observe(partial(self._data_update_dep, dataclass=dataclass),
                                                    names='v_model')
        self.arrival_airport_autocomplete.observe(partial(self._data_update_arr, dataclass=dataclass), names='v_model')
        self.airline_autocomplete.observe(partial(self._data_update_airline, dataclass=dataclass), names='v_model')
        self.aircraft_autocomplete.observe(partial(self._data_update_aircraft, dataclass=dataclass), names='v_model')
    ...
    def _render_initial_plots(self, dataclass):
        ...
        with self.output_2:
            fig_flights_2 = flight_level_plots.distance_histogramm_plot_flights(dataclass.flights_df, 'co2')
            display(fig_flights_2)

        with self.output_3:
            fig_flights_3 = flight_level_plots.aircraft_pie_flights(dataclass.flights_df, 'co2')
        ...
        if len(self.in_class_flights_df) < 20000:
            ...
            with self.output_1:
                ...
                if active_main_graph_flights == 'map':
                    ...
                    flights_df_od = self.in_class_flights_df.groupby(['iata_departure', 'iata_arrival']).agg({
                        'acft_icao': ', '.join,
                        'airline_iata': ', '.join,
                        'departure_lon': 'first',
                        'departure_lat': 'first',
                    ...
                    fig_flights_1 = flight_level_plots.flights_treemap_plot(self.in_class_flights_df,
    ...
    def _plot2_update(self, change):
        ...
        with self.output_2:
            ...
            if active_analysis_graph_flights == 'hist':
                fig_flights_2 = flight_level_plots.distance_histogramm_plot_flights(self.in_class_flights_df,
                                                                                    value_watched_flights)
            elif active_analysis_graph_flights == 'ecdf':
                fig_flights_2 = flight_level_plots.distance_cumul_plot_flights(self.in_class_flights_df)
            elif active_analysis_graph_flights == 'kde_acft':
                fig_flights_2 = flight_level_plots.distance_share_flights(self.in_class_flights_df,
                                                                          value_watched_flights)
            else:
                fig_flights_2 = flight_level_plots.distance_share_dom_int_flights(self.in_class_flights_df,
                                                                                  value_watched_flights)
            display(fig_flights_2)
    ...
    def _plot3_update(self, change):
        ...
        with self.output_3:
            ...
            if active_pie_graph_flights == 'acft':
                fig_flights_3 = flight_level_plots.aircraft_pie_flights(self.in_class_flights_df, value_watched_flights)
            elif active_pie_graph_flights == 'acft_class':
                fig_flights_3 = flight_level_plots.aircraft_class_pie_flights(self.in_class_flights_df,
                                                                              value_watched_flights)
            elif active_pie_graph_flights == 'airline':
                fig_flights_3 = flight_level_plots.aircraft_user_pie_flights(self.in_class_flights_df,
                                                                             value_watched_flights)
            else:
                fig_flights_3 = flight_level_plots.dom_share_pie_flights(self.in_class_flights_df,
                                                                         value_watched_flights)
            display(fig_flights_3)
                        ...
                        v.Col(
                            ...
                            children=[
                                v.Card(
                                    ...
                                    elevation=0,
                                    children=[
                                        v.Html(tag="div", class_="d-flex justify-center",
