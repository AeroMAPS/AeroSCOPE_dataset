...
The fourth folder ([04_applications](https://github.com/AeroMAPS/AeroSCOPE/tree/main/aeroscope/04_applications)) contains application cases notebooks used in a submitted extended article. It contains a preprocessing notebook to format the database for AeroSCOPE usage. It also contains **an empty notebook** used as a link to the dedicated web app, which is stored on https://github.com/AeroMAPS/AeroSCOPE and deployed at www.aeroscope.isae-supaero.fr

Finally, there are two extra folders for specific applications cases not yet documented. (00 and 01_to_03)
